...
namespace Microsoft.GameCore.Tools
{
    public class GdkBuildEditorWindow : EditorWindow
    {
        ...
        private bool IsGameCoreScriptingDefineEnabled()
        {
            ...
            string existingScriptingDefineSymbolsForGroup = PlayerSettings.GetScriptingDefineSymbols(NamedBuildTarget.Standalone);
        ...
        private void EnableGameCoreScriptingDefine()
        {
            ...
            if (!IsGameCoreScriptingDefineEnabled())
            {
                ...
                PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.Standalone, existingScriptingDefineSymbolsForGroup + GameCorePlatformDefine + ";");
        ...
        private void DisableGameCoreScriptingDefine()
        {
            ...
            if (existingScriptingDefineSymbolsForGroup.Contains(GameCorePlatformDefine))
            {
                ...
                PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.Standalone, newScriptingDefineSymbolsForGroup);
