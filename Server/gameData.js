...
const UnitTemplates = {
    ...
    'archer': {
        ...
        stats: { health: 400, attack: 55, armor: 15, magicResist: 15, attackSpeed: 0.8, range: 4, mana: 50 }
    },
    'bat': {
        unitId: 'bat',
        name: 'Bat',
        ...
        stats: { health: 400, attack: 55, armor: 15, magicResist: 15, attackSpeed: 0.9, range: 1, mana: 40 }
    },
    'blueslime': {
        unitId: 'blueslime',
        name: 'Blue Slime',
        ...
        stats: { health: 550, attack: 40, armor: 25, magicResist: 25, attackSpeed: 0.6, range: 1, mana: 60 }
    },
    'crawler': {
        unitId: 'crawler',
        name: 'Crawler',
        ...
        stats: { health: 420, attack: 50, armor: 25, magicResist: 15, attackSpeed: 0.75, range: 1, mana: 50 }
    },
    'greenspider': {
        unitId: 'greenspider',
        name: 'Green Spider',
        ...
        stats: { health: 500, attack: 40, armor: 30, magicResist: 25, attackSpeed: 0.65, range: 1, mana: 55 }
    },
    'littledemon': {
        unitId: 'littledemon',
        name: 'Little Demon',
        ...
        stats: { health: 400, attack: 60, armor: 15, magicResist: 20, attackSpeed: 0.8, range: 2, mana: 45 }
    },
    'mushroom': {
        unitId: 'mushroom',
        name: 'Mushroom',
        ...
        stats: { health: 480, attack: 35, armor: 20, magicResist: 30, attackSpeed: 0.6, range: 2, mana: 60 }
    },
    'ratassassin': {
        unitId: 'ratassassin',
        name: 'Rat Assassin',
        ...
        stats: { health: 380, attack: 65, armor: 15, magicResist: 15, attackSpeed: 0.85, range: 1, mana: 40 }
    },
    'redslime': {
        unitId: 'redslime',
        name: 'Red Slime',
        ...
        stats: { health: 450, attack: 45, armor: 20, magicResist: 20, attackSpeed: 0.65, range: 1, mana: 50 }
    },
    'starfish': {
        unitId: 'starfish',
        name: 'Starfish',
        ...
        stats: { health: 520, attack: 35, armor: 20, magicResist: 25, attackSpeed: 0.55, range: 1, mana: 65 }
    },
    ...
    'battlebee': {
        ...
        cost: 2,
        traits: ['fury', 'cleave'],
        stats: { health: 480, attack: 60, armor: 20, magicResist: 20, attackSpeed: 0.85, range: 1, mana: 45 }
    },
    'blacksmith': {
        unitId: 'blacksmith',
        name: 'Blacksmith',
        cost: 2,
        traits: ['crestmaker'],
        stats: { health: 650, attack: 50, armor: 30, magicResist: 30, attackSpeed: 0.6, range: 1, mana: 80 }
    },
    'chestmonster': {
        unitId: 'chestmonster',
        name: 'Chest Monster',
        cost: 2,
        traits: ['treasure'],
        stats: { health: 600, attack: 55, armor: 35, magicResist: 25, attackSpeed: 0.6, range: 1, mana: 60 }
    },
    'crabmonster': {
        unitId: 'crabmonster',
        name: 'Crab Monster',
        ...
        stats: { health: 700, attack: 50, armor: 45, magicResist: 25, attackSpeed: 0.55, range: 1, mana: 70 }
    },
    'evilplant': {
        unitId: 'evilplant',
        name: 'Evil Plant',
        cost: 2,
        traits: ['invigorating', 'volatile'],
        stats: { health: 580, attack: 50, armor: 25, magicResist: 30, attackSpeed: 0.6, range: 2, mana: 60 }
    },
    'fishman': {
        unitId: 'fishman',
        name: 'Fishman',
        ...
        stats: { health: 600, attack: 55, armor: 30, magicResist: 20, attackSpeed: 0.7, range: 1, mana: 60 }
    },
    'flowermonster': {
        ...
        stats: { health: 500, attack: 45, armor: 20, magicResist: 35, attackSpeed: 0.6, range: 3, mana: 80 }
    },
    'golem': {
        unitId: 'golem',
        name: 'Golem',
        ...
        stats: { health: 800, attack: 50, armor: 40, magicResist: 25, attackSpeed: 0.5, range: 1, mana: 75 }
    },
    'salamander': {
        unitId: 'salamander',
        name: 'Salamander',
        ...
        stats: { health: 550, attack: 65, armor: 25, magicResist: 30, attackSpeed: 0.7, range: 2, mana: 55 }
    },
    'wormmonster': {
        unitId: 'wormmonster',
        name: 'Worm Monster',
        cost: 2,
        traits: ['bruiser', 'mitigation'],
        stats: { health: 750, attack: 45, armor: 35, magicResist: 30, attackSpeed: 0.5, range: 1, mana: 70 }
    },
    ...
    'beholder': {
        ...
        stats: { health: 550, attack: 65, armor: 20, magicResist: 45, attackSpeed: 0.6, range: 4, mana: 70 }
    },
    'cleric': {
        unitId: 'cleric',
        name: 'Cleric',
        ...
        stats: { health: 700, attack: 45, armor: 30, magicResist: 45, attackSpeed: 0.55, range: 3, mana: 100 }
    },
    'cyclops': {
        unitId: 'cyclops',
        name: 'Cyclops',
        ...
        stats: { health: 850, attack: 90, armor: 35, magicResist: 25, attackSpeed: 0.6, range: 1, mana: 70 }
    },
    'icegolem': {
        unitId: 'icegolem',
        name: 'Ice Golem',
        ...
        stats: { health: 950, attack: 55, armor: 45, magicResist: 40, attackSpeed: 0.5, range: 1, mana: 80 }
    },
    'lizardwarrior': {
        ...
        stats: { health: 800, attack: 75, armor: 40, magicResist: 25, attackSpeed: 0.7, range: 1, mana: 65 }
    },
    'nagawizard': {
        unitId: 'nagawizard',
        name: 'Naga Wizard',
        ...
        stats: { health: 650, attack: 55, armor: 25, magicResist: 50, attackSpeed: 0.6, range: 4, mana: 90 }
    },
    'specter': {
        unitId: 'specter',
        name: 'Specter',
        ...
        stats: { health: 600, attack: 60, armor: 20, magicResist: 45, attackSpeed: 0.65, range: 3, mana: 75 }
    },
    'werewolf': {
        unitId: 'werewolf',
        name: 'Werewolf',
        ...
        stats: { health: 750, attack: 85, armor: 30, magicResist: 25, attackSpeed: 0.85, range: 1, mana: 55 }
    },
    ...
    'bishopknight': {
        ...
        stats: { health: 1100, attack: 70, armor: 60, magicResist: 50, attackSpeed: 0.5, range: 1, mana: 90 }
    },
    'blackknight': {
        unitId: 'blackknight',
        name: 'Black Knight',
        ...
        stats: { health: 1000, attack: 95, armor: 55, magicResist: 35, attackSpeed: 0.65, range: 1, mana: 80 }
    },
    'bonedragon': {
        unitId: 'bonedragon',
        name: 'Bone Dragon',
        ...
        stats: { health: 900, attack: 80, armor: 35, magicResist: 40, attackSpeed: 0.6, range: 2, mana: 85 }
    },
    'eviloldmage': {
        unitId: 'eviloldmage',
        name: 'Evil Old Mage',
        ...
        stats: { health: 700, attack: 70, armor: 25, magicResist: 55, attackSpeed: 0.55, range: 4, mana: 95 }
    },
    'fatdragon': {
        unitId: 'fatdragon',
        name: 'Fat Dragon',
        ...
        stats: { health: 1200, attack: 85, armor: 45, magicResist: 40, attackSpeed: 0.5, range: 1, mana: 85 }
    },
    'flyingdemon': {
        unitId: 'flyingdemon',
        name: 'Flying Demon',
        ...
        stats: { health: 850, attack: 100, armor: 30, magicResist: 35, attackSpeed: 0.75, range: 1, mana: 70 }
    },
    'orcwithmace': {
        unitId: 'orcwithmace',
        name: 'Orc with Mace',
        ...
        stats: { health: 950, attack: 110, armor: 40, magicResist: 30, attackSpeed: 0.6, range: 1, mana: 75 }
    },
    ...
    'castlemonster': {
        ...
        stats: { health: 1500, attack: 80, armor: 60, magicResist: 50, attackSpeed: 0.4, range: 1, mana: 100 }
    },
    'demonking': {
        unitId: 'demonking',
        name: 'Demon King',
        ...
        stats: { health: 1100, attack: 120, armor: 45, magicResist: 45, attackSpeed: 0.65, range: 1, mana: 100 }
    },
    'flameknight': {
        unitId: 'flameknight',
        name: 'Flame Knight',
        ...
        stats: { health: 950, attack: 105, armor: 40, magicResist: 45, attackSpeed: 0.65, range: 1, mana: 85 }
    },
    'skeletonmage': {
        unitId: 'skeletonmage',
        name: 'Skeleton Mage',
        ...
        stats: { health: 750, attack: 75, armor: 25, magicResist: 55, attackSpeed: 0.55, range: 4, mana: 120 }
    },
    'spikyshellturtle': {
        ...
        cost: 5,
        traits: ['reflective', 'mitigation'],
        stats: { health: 1400, attack: 60, armor: 70, magicResist: 60, attackSpeed: 0.35, range: 1, mana: 90 }
    },
    ...
    'stingray': {
        ...
        traits: [],
        stats: { health: 80, attack: 15, armor: 0, magicResist: 0, attackSpeed: 0.6, range: 1, mana: 0 },
        isPvE: true
    },
    'cactus': {
        unitId: 'cactus',
        ...
        cost: 0,
        traits: [],
        stats: { health: 100, attack: 10, armor: 5, magicResist: 0, attackSpeed: 0.5, range: 2, mana: 0 },
        isPvE: true
    }
};
